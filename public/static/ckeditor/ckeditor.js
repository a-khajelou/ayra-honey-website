...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var a = {timestamp: "E4KA", version: "4.4.1", revision: "568b5ed", rnd: Math.floor(900 * Math.random()) + 100, _: {pending: []}, status: "unloaded", basePath: function () {
    ...
    (function () {
        ...
        CKEDITOR.tools = {arrayCompare: function (a, d) {
            if (!a && !d)return true;
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, e = function (a, d) {
            ...
            return f
        }, b = {}, c = {}, d = {address: 1, article: 1, aside: 1, blockquote: 1, details: 1, div: 1, dl: 1, fieldset: 1, figure: 1, footer: 1, form: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, header: 1, hgroup: 1, hr: 1, menu: 1, nav: 1, ol: 1, p: 1, pre: 1, section: 1, table: 1, ul: 1}, f = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, h = {}, n = {"#": 1}, i = {center: 1, dir: 1, noframes: 1};
    ...
    (function () {
        ...
        var c = {block: 1, "list-item": 1, table: 1, "table-row-group": 1, "table-header-group": 1, "table-footer-group": 1, "table-row": 1, "table-column-group": 1, "table-column": 1, "table-cell": 1,
            "table-caption": 1}, d = {absolute: 1, fixed: 1};
    ...
    (function () {
        ...
        {clone: function () {
            ...
            return function (b) {
                ...
                return{start: d.container.getAddress(b), end: c ? null : g.container.getAddress(b),
    ...
    (function () {
        ...
        function v(a, b, d, g) {
            ...
            if (g.doFilter) {
                a:{
                    ...
                    h = g.skipRequired;
                    q = {valid: false, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: false, allClasses: false, allStyles: false, hadInvalidAttribute: false, hadInvalidClass: false, hadInvalidStyle: false};
                    var w, t;
                    if (!a && !j)a = null; else {
                        r(b);
                        if (l) {
        ...
        CKEDITOR.filter.prototype = {allow: function (b, c, d) {
            ...
            var g = this, f = [], e = this.editor && this.editor.config.protectedSource, j, l = false, p = {doFilter: !c, doTransform: true, doCallbacks: true, toHtml: b};
            a.forEach(function (a) {
                if (a.type == CKEDITOR.NODE_ELEMENT) {
        ...
        var y = {styles: 1, attributes: 1, classes: 1}, B = {styles: "requiredStyles", attributes: "requiredAttributes",
            classes: "requiredClasses"}, w = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, N = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, M = /^cke:(object|embed|param)$/, D = /^(object|embed|param)$/, ba = CKEDITOR.filter.transformationsTools = {sizeToStyle: function (a) {
    ...
    (function () {
        ...
        var e = CKEDITOR.tools.extend({table: 1, ul: 1, ol: 1, dl: 1}, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), b = {ol: 1, ul: 1}, c = CKEDITOR.tools.extend({}, {html: 1}, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, {style: 1, script: 1}), d = {ul: "li", ol: "li", dl: "dd", table: "tbody", tbody: "tr", thead: "tr", tfoot: "tr", tr: "td"};
    ...
    (function () {
        ...
        a.prototype = {add: function (a, c, d) {
            ...
            for (var f = [this.findIndex(c), 0], e = 0, n = a.length; e < n; e++)f.push({value: a[e], priority: c, options: d});
    ...
    (function () {
        ...
        var z = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}", l = CKEDITOR.dtd, j = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], m = CKEDITOR.tools.extend({}, l.$blockLimit, l.$block), u = {elements: {input: n, textarea: n}}, P = {attributeNames: [
            [/^on/, "data-cke-pa-on"],
            [/^data-cke-expando$/, ""]
        ]}, q = {elements: {embed: function (a) {
            var b = a.parent;
            if (b && b.name == "object") {
    ...
    (function () {
        ...
        var r = function () {
            ...
            var m = CKEDITOR.dtd, h = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1}, k = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, q = CKEDITOR.tools.extend({}, m.$inline);
            delete q.br;
            return function (h, i, u) {
                var o = h.editor;
                h.getDocument();
                ...
                if (!s.checkReadOnly()) {
                    var t = (new CKEDITOR.dom.elementPath(s.startContainer, s.root)).blockLimit || s.root, i = {type: i, dontFilter: r, editable: h, editor: o, range: s, blockLimit: t, mergeCandidates: [], zombies: []}, o = i.range, r = i.mergeCandidates, x, y, B, w;
    ...
    (function () {
        ...
        var P = {address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1}, q =
        {a: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1, dt: 1, dd: 1, form: 1, audio: 1, video: 1}, L = /\s*(?:;\s*|$)/, H = /#\((.+?)\)/g, G = CKEDITOR.dom.walker.bookmark(0, 1), C = CKEDITOR.dom.walker.whitespaces(1);
    ...
    (function () {
        function v(b) {
            ...
            function l(a, d) {
                ...
                if (!c.getById("cke_pastebin")) {
                    ...
                    k.setStyles({position: "absolute", top: c.getScrollPosition().y - f + 10 + "px", width: "1px", height: Math.max(1, c.getViewPaneSize().height -
        ...
        function y() {
            var b = new CKEDITOR.htmlParser.filter, a = {blockquote: 1, dl: 1, fieldset: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1,
                ol: 1, p: 1, table: 1, ul: 1}, c = CKEDITOR.tools.extend({br: 0}, CKEDITOR.dtd.$inline), d = {p: 1, br: 1, "cke:br": 1}, g = CKEDITOR.dtd, i = CKEDITOR.tools.extend({area: 1, basefont: 1, embed: 1, iframe: 1, map: 1, object: 1, param: 1}, CKEDITOR.dtd.$nonBodyContent, CKEDITOR.dtd.$cdata), h = function (a) {
                delete a.name;
    ...
    (function () {
        ...
        CKEDITOR.ui.panel.block =
            CKEDITOR.tools.createClass({$: function (a, b) {
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("link", {requires: "dialog,fakeobjects", onLoad: function () {
            ...
            c.addMenuItems && c.addMenuItems({anchor: {label: c.lang.link.anchor.menu, command: "anchor", group: "anchor", order: 1}, removeAnchor: {label: c.lang.link.anchor.remove, command: "removeAnchor", group: "anchor", order: 5}, link: {label: c.lang.link.menu, command: "link", group: "link", order: 1}, unlink: {label: c.lang.link.unlink,
        ...
        CKEDITOR.removeAnchorCommand.prototype = {exec: function (c) {
            ...
            if (b && (f = b.getSelectedElement()) && (!f.getChildCount() ? CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, f) : f.is("a")))f.remove(1); else if (f = CKEDITOR.plugins.link.getSelectedLink(c))f.hasAttribute("href") ? (f.removeAttributes({name: 1, "data-cke-saved-name": 1}), f.removeClass("cke_anchor")) : f.remove(1);
            b.selectBookmarks(a)
    ...
    CKEDITOR.plugins.add("scayt", {requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", init: function (a) {
        ...
        if (b && b.length)for (var f = 0; f < b.length; f++)a.addMenuGroup("scayt_" +
            b[f], f - 10);
        b = {scaytToggle: {label: a.lang.scayt.btn_enable, group: "scaytButton", onClick: function () {
            var b = a.scayt;
            c.state[a.name] = !c.state[a.name];
            !0 === c.state[a.name] ? b || c.createScayt(a) : b && c.destroy(a)
        }}, scaytAbout: {label: a.lang.scayt.btn_about, group: "scaytButton", onClick: function () {
            a.scayt.tabToOpen = "about";
            a.lockSelection();
            a.openDialog(d.dialogName)
        }}, scaytOptions: {label: a.lang.scayt.btn_options, group: "scaytButton", onClick: function () {
            a.scayt.tabToOpen = "options";
            a.lockSelection();
            a.openDialog(d.dialogName)
        }},
            scaytLangs: {label: a.lang.scayt.btn_langs, group: "scaytButton", onClick: function () {
                a.scayt.tabToOpen = "langs";
                a.lockSelection();
                a.openDialog(d.dialogName)
            }}, scaytDict: {label: a.lang.scayt.btn_dictionaries, group: "scaytButton", onClick: function () {
        ...
        b && b.push(g);
        d && d.addRules({elements: {span: function (c) {
            var b = CKEDITOR.plugins.scayt;
        ...
        c && c.addRules({elements: {span: function (c) {
            var b =
        ...
        return{scayt_ignore: {label: a.getLocal("btn_ignore"), group: "scayt_control", order: 1, exec: function (a) {
            a.scayt.ignoreWord()
        ...
        }}, option: {label: a.getLocal("btn_options"), group: "scayt_control", order: 4, exec: function (a) {
            a.scayt.tabToOpen = "options";
            a.lockSelection();
            a.openDialog(d.dialogName)
        }, verification: function (a) {
            return 1 == a.config.scayt_uiTabs[0] ? !0 : !1
        }}, language: {label: a.getLocal("btn_langs"),
            ...
            }}, dictionary: {label: a.getLocal("btn_dictionaries"), group: "scayt_control", order: 6, exec: function (a) {
            a.scayt.tabToOpen = "dictionaries";
            a.lockSelection();
            a.openDialog(d.dialogName)
        }, verification: function (a) {
            return 1 == a.config.scayt_uiTabs[2] ? !0 : !1
        }}, about: {label: a.getLocal("btn_about"), group: "scayt_control", order: 7, exec: function (a) {
            a.scayt.tabToOpen =
                "about";
            a.lockSelection();
            a.openDialog(d.dialogName)
        ...
        if (0 < d.length && "no_any_suggestions" !== d[0])for (var g = 0; g < d.length; g++) {
            ...
            g < a.config.scayt_maxSuggestions ? (a.addMenuItem(e, {label: d[g], command: e, group: "scayt_suggest", order: g + 1}), c[e] = CKEDITOR.TRISTATE_OFF) : (a.addMenuItem(e, {label: d[g],
                command: e, group: "scayt_moresuggest", order: g + 1}), b[e] = CKEDITOR.TRISTATE_OFF, "on" === a.config.scayt_moreSuggestions && (a.addMenuItem("scayt_moresuggest", {label: f.getLocal("btn_moreSuggestions"), group: "scayt_moresuggest", order: 10, getItems: function () {
                return b
            }}), c.scayt_moresuggest = CKEDITOR.TRISTATE_OFF))
        } else c.no_scayt_suggest = CKEDITOR.TRISTATE_DISABLED, a.addCommand("no_scayt_suggest", {exec: function () {
        }}), a.addMenuItem("no_scayt_suggest", {label: f.getLocal("btn_noSuggestions") || "no_scayt_suggest", command: "no_scayt_suggest",
    ...
    (function () {
        CKEDITOR.plugins.add("stylescombo", {requires: "richcombo", init: function (c) {
            ...
            c.ui.addRichCombo("Styles", {label: g.label, title: g.panelTitle, toolbar: "styles,10", allowedContent: k, panel: {css: [CKEDITOR.skin.getPath("editor")].concat(j.contentsCss), multiSelect: !0, attributes: {"aria-label": g.panelTitle}}, init: function () {
                var b, a, c, d, e, f;
                e = 0;
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("undo", {init: function (a) {
            ...
            a.on("mode", d);
            a.on("readOnly", d);
            a.ui.addButton && (a.ui.addButton("Undo", {label: a.lang.undo.undo, command: "undo", toolbar: "undo,10"}), a.ui.addButton("Redo", {label: a.lang.undo.redo, command: "redo",
                toolbar: "undo,20"}));
