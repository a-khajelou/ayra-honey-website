...
<?php 
	$counter = 1;
    if (Input::has('page'))
       $counter+=Slider::$paginate_per_page*(Input::get('page')-1);
	...
	<table class="table table-striped table-hover tablesorter">
		...
		@foreach ($all_objs as $obj)
			<tr>
    			...
    			@if(Input::has('deleted') || (Input::has('page_mode') && Input::get('page_mode')=='deleted'))
    			<td>
    				{{Form::open(array('url' => '/admin/slider/'.$obj->id.'?forcedelete=true', 'method' => 'delete'))}}
    			...
    			@endif
    			<td>
    				{{Form::open(array('url' => '/admin/slider/'.$obj->id.'/edit', 'method' => 'get'))}}
