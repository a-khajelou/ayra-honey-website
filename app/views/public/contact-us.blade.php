        ...
        <div class="wrapper">
            <div class="grid_4 alpha">
                ...
                <figure class="img_inner">
                    <script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false"></script><div style="overflow:hidden;height:224px;width:224px;"><div id="gmap_canvas" style="height:224px;width:224px;"></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style><a class="google-map-code" href="http://www.leaksmirror.com" id="get-map-data">http://www.leaksmirror.com</a></div><script type="text/javascript"> function init_map(){var myOptions = {zoom:11,center:new google.maps.LatLng(35.6907189,51.257945199999995),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById("gmap_canvas"), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(35.6907189, 51.257945199999995)});infowindow = new google.maps.InfoWindow({content:"<b>Error SWG Co</b><br/>Tehransar<br/> Tehran,Iran" });google.maps.event.addListener(marker, "click", function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
